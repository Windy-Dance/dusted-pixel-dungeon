...
| 属性 | 值 |
|------|-----|
| 文件路径 | core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/items/armor/ClericArmor.java |
...
## 2. 类职责说明
ClericArmor（牧师护甲）是牧师职业使用国王皇冠升级护甲后获得的职业护甲。继承所有ClassArmor的功能，拥有牧师特有的外观。
...
| 字段名 | 类型 | 修饰符 | 说明 |
|--------|------|--------|------|
| image | int | 初始化块 | 精灵图为 ARMOR_CLERIC |

## 7. 方法详解

### 构造函数
**签名**: `public ClericArmor()`
**功能**: 创建牧师护甲
**实现逻辑**:
```java
// 继承ClassArmor所有功能
