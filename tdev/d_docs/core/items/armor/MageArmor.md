...
| 属性 | 值 |
|------|-----|
| 文件路径 | core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/items/armor/MageArmor.java |
...
## 2. 类职责说明
MageArmor（法师护甲）是法师职业使用国王皇冠升级护甲后获得的职业护甲。继承所有ClassArmor的功能，拥有法师特有的外观。
...
| 字段名 | 类型 | 修饰符 | 说明 |
|--------|------|--------|------|
| image | int | 初始化块 | 精灵图为 ARMOR_MAGE |
