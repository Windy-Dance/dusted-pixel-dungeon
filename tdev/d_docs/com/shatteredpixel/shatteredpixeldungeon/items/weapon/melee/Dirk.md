...
| 属性 | 值 |
|------|-----|
| 文件路径 | core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/items/weapon/melee/Dirk.java |
...
## 2. 类职责说明
Dirk（短剑/匕首）是一种 Tier 2 的近战武器，对偷袭的敌人造成更高的伤害。作为决斗家武器，其特殊能力「潜行」可以让英雄进入隐身状态。短剑是适合偷袭战术的武器，在敌人未警觉时效果更佳。
...
| 字段名 | 类型 | 修饰符 | 说明 |
|--------|------|--------|------|
| image | int | 初始化块 | 物品图标，使用 ItemSpriteSheet.DIRK |
