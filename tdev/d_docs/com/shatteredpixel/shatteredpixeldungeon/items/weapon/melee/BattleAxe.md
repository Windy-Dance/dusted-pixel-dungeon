...
| 属性 | 值 |
|------|-----|
| 文件路径 | core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/items/weapon/melee/BattleAxe.java |
...
## 2. 类职责说明
BattleAxe（战斧）是一种 Tier 4 的近战武器，具有较高的准确度（ACC=1.24f）。作为决斗家武器，其特殊能力「重击」可以造成额外伤害并使敌人眩晕，对未被警觉的敌人效果更好。战斧是平衡的伤害型武器。
